...
Простой REST API для работы с пользователями: регистрация, авторизация, просмотр профиля, список пользователей (только админ) и блокировка (самого себя или админа).
